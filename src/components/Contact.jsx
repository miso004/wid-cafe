      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
                ...
                <div key={index} className="bg-card border border-border rounded-radius overflow-hidden transition-shadow hover:shadow-lg">
                  <div className="p-6 pb-4">
                    <div className="flex items-start gap-3 mb-4">
                      <div className="p-2 bg-primary bg-opacity-10 rounded-radius">
                        {info.icon}
                      </div>
            ...
            <div className="space-y-4">
              <div className="grid md:grid-cols-2 gap-4">
                <a href="#" className="inline-flex items-center justify-center px-8 py-4 text-lg font-medium rounded-radius bg-primary text-primary-foreground hover:bg-opacity-90 transition-colors duration-200 w-full">
                  <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z"/>
                  </svg>
                  Make Reservation
                </a>
                <a href="#" className="inline-flex items-center justify-center px-8 py-4 text-lg font-medium rounded-radius border border-border text-foreground hover:bg-accent transition-colors duration-200 w-full">
                  <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z"/>
                  </svg>
                  Get Directions
          ...
          <div className="bg-card border border-border rounded-radius overflow-hidden">
            <div className="bg-muted h-96 flex items-center justify-center rounded-radius relative">
              <div className="text-center">
                ...
                <a href="#" className="inline-flex items-center justify-center px-6 py-3 text-sm font-medium rounded-radius bg-primary text-primary-foreground hover:bg-opacity-90 transition-colors duration-200">
              ...
              {/* Address overlay */}
              <div className="absolute bottom-4 left-4 right-4 bg-white bg-opacity-95 backdrop-blur-sm rounded-radius p-4">
        ...
        {/* Metro Information */}
        <div className="bg-card border border-border rounded-radius mt-12">
