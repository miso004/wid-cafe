      ...
      <div className="max-w-6xl mx-auto px-4 text-center">
        <div className="max-w-3xl mx-auto">
          <div className="flex justify-center mb-6">
            {[...Array(5)].map((_, index) => (
              <svg key={index} className="w-8 h-8 text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="flex flex-col gap-4 items-center">
            <a href="#" className="inline-flex items-center justify-center px-8 py-4 text-lg font-medium rounded-radius bg-white text-primary hover:bg-gray-100 transition-colors duration-200">
            ...
            <a href="#" className="inline-flex items-center justify-center px-8 py-4 text-lg font-medium rounded-radius border border-white text-white hover:bg-white hover:text-primary transition-colors duration-200">
              <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
